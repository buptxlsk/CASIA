...
class MainWindow(QMainWindow):
    ...
    def set_coordinate_system(self):
        if self.AODA is not None and self.ANS is not None and self.HtL is not None and self.HtR is not None and self.SR is not None:
            ...
            vector_coronal = np.cross(vector_axial, vector_CD) #冠状面的法向量
            ...
            print(f"Input angles: ({self.SR[2][0]}, {self.SR[2][1]}, {self.SR[2][2]})")
            point = self.calculate_position_in_key_coordinates(self.SR[1][0],
                                                               self.SR[1][1],
                                                               self.SR[1][2],
                                                               self.SR[2][0],
                                                               self.SR[2][1],
